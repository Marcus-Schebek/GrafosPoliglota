...
impl Grafo {
    fn new(max_vertices: usize) -> Grafo {
        Grafo {
            vertices: Vec::new(),
            arestas: HashMap::new(),
            max_vertices,
    ...
    fn adicionar_vertice(&mut self, vertice: u32) {
    ...
    fn adicionar_aresta(&mut self, vertice_origem: u32, vertice_destino: u32, peso: u32) {
